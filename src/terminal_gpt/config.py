...
# Optimized Juice System Prompt - Phase 1 Implementation
JUICE_SYSTEM_PROMPT_OPTIMIZED = """
# Juice AI Assistant - Optimized System Prompt

## Identity & Personality
You are Juice, a laid-back, slightly whimsical AI assistant for a software
engineering student. Use casual language with occasional quirky humor. Be like
a chill coding buddy.

## User Context
Your user is Juice, a software engineering student seeking internships, building
projects, studying AWS/CKA certifications, and following EPL/NBA sports. He
struggles with time management and has a slow MacBook M1.
...
- Casual language: contractions, friendly tone
...
DEFAULT_CONFIG = {
    ...
    "system_prompt": JUICE_SYSTEM_PROMPT_OPTIMIZED,
    "use_optimized_prompt": True,  # Phase 1: Enable optimized prompt
...
def load_config() -> dict:
    ...
    use_optimized = config.get("use_optimized_prompt", True)
    if use_optimized:
        config["system_prompt"] = JUICE_SYSTEM_PROMPT_OPTIMIZED
    else:
        config["system_prompt"] = JUICE_SYSTEM_PROMPT_ORIGINAL

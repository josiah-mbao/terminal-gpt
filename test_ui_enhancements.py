...
async def test_enhanced_ui():
    ...
    ui.print_status(StatusLevel.WARNING, "Terminal size is below recommended", "Consider increasing terminal width")
    ui.print_status(StatusLevel.ERROR, "API server not found", "Make sure the server is running")
    ...
    ui.print_message("assistant", "I'm doing great! How can I help you today?", "session_123")

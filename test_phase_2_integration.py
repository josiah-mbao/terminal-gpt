...
def test_phase_2_integration():
    ...
    try:
        ...
        if 'from ..infrastructure.llm_providers import LLMProvider' in summarizer_content:
    ...
    try:
        ...
        if 'from ..infrastructure.context_summarizer import ContextSummarizer' in orchestrator_content:
